            ...
            <div id="collapse_1" className="accordion-collapse collapse" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  ...
                  <p className="mb-0">
                    For example: If someone else uses your phone and launches the GapxBit web/app, they will be prompted to enter a six-digit PIN in order to gain access. They cannot access your GapxBit account on the web/app since the 6-digit PIN is exclusive to you.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card  p-0 ">
            ...
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  <p className=" mb-0 ">
                    As part of our continued efforts to make your GapxBit account safe, we expect to make PIN mandatory in the future. For now, this is an optional feature, however, we encourage you to make use of it.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card  p-0  ">
            <h2 className="card-header" id="headingcollapse_3">
              <button className="accordion-button p-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_3" aria-expanded="false" aria-controls="collapse_3">
                Will the PIN feature also be enabled for the GapxBit on web?
              </button>
            </h2>
            <div id="collapse_3" className="accordion-collapse collapse" aria-labelledby="headingcollapse_3" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top border-bottom  ">
                <div className="faq_text" >
                  <p className="mb-0" > PIN feature is now also available on GapxBit app/web.  </p>
                </div>
              </div>
            </div>
          </div>
          <div className="card p-0  ">
            ...
            <div id="collapse_4" className="accordion-collapse collapse" aria-labelledby="headingcollapse_4" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    PIN feature is now also available on GapxBit app/web.
                  </p>
                </div>
              </div>
            </div>
      ...
      {changeScreen === "Create an Account" && (
        <div className="faq " id="accordionExample">
          <div className="card p-0  ">
            ...
            <div id="collapse_1" className="accordion-collapse collapse" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <p className=" ">
                    Download and open the official GapxBit App on <span className="text-warning" >Android</span> or <span className="text-warning"  >iOS</span> to get started. Always ensure to download and install the app from official sources only.
          ...
          <div className="card  p-0 ">
            <h2 className="card-header" id="headingcollapse_2">
              <button className="accordion-button p-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_2" aria-expanded="false" aria-controls="collapse_2">
                What mobile devices does GapxBit support
              </button>
            </h2>
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  <p className=" ">
                    The GapxBit is supported on both Android and iOS. Please ensure to download and install the app from official sources only.
                  </p>
                  <p className="">
          ...
          <div className="card  p-0  ">
            <h2 className="card-header" id="headingcollapse_3">
              <button className="accordion-button p-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_3" aria-expanded="false" aria-controls="collapse_3">
                Can I have multiple accounts on GapxBit?
              </button>
            </h2>
            <div id="collapse_3" className="accordion-collapse collapse" aria-labelledby="headingcollapse_3" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top border-bottom  ">
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_4" className="accordion-collapse collapse" aria-labelledby="headingcollapse_4" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    Please note that you can only have one account with GapxBit with the same set of KYC documents
                  </p>
                </div>
              </div>
            </div>
      ...
      {changeScreen === "Login" && (
        <div className="faq " id="accordionExample">
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_1">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_1" aria-expanded="false" aria-controls="collapse_1">
                How do I log in to my GapxBit account?
              </button>
            </h2>
            <div id="collapse_1" className="accordion-collapse collapse" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <p className=" ">
                    Follow the steps below to log into your GapxBit account:
                  </p>
                  <ol>
                  ...
                  <p className="mb-0"> <strong>Important:</strong> Always ensure to download and install the app or web login from official sources only. Use this link to login to GapxBit on your device: link  </p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  ...
                  <p className=" mb-0 ">
                    <strong>Important</strong>: Contact help center or contact us at <a href="mailto:support@GapxBitglobal.io" >support@GapxBitglobal.io</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card  p-0  ">
            ...
            <div id="collapse_3" className="accordion-collapse collapse" aria-labelledby="headingcollapse_3" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top border-bottom  ">
                <div className="faq_text" >
                  <p className="" >Follow the steps below to reset your GapxBit account password: </p>
                  <ol>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_4">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_4" aria-expanded="false" aria-controls="collapse_4">
                How to change my password on GapxBit?
              </button>
            </h2>
            <div id="collapse_4" className="accordion-collapse collapse" aria-labelledby="headingcollapse_4" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className=" ">
                    Follow the steps below to change your GapxBit account password:
                  </p>
                  <ol>
                    <li>1. Login to GapxBit and click on the profile icon on top left of the screen. </li>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_5">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_5" aria-expanded="false" aria-controls="collapse_5">
                I am unable to reset password on GapxBit . What do I do?
              </button>
            </h2>
            <div id="collapse_5" className="accordion-collapse collapse" aria-labelledby="headingcollapse_5" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    If you are having trouble changing your password on GapxBit, write to us at <b><a href="mailto:support@GapxBitglobal.io" >support@GapxBitglobal.io.</a></b>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_6" className="accordion-collapse collapse" aria-labelledby="headingcollapse_6" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    If you find your account has been blocked due to any reason, please submit a request to the support team at <b><a href="mailto:support@GapxBitglobal.io" >support@GapxBitglobal.io</a></b> and they will assist you further.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_7">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_7" aria-expanded="false" aria-controls="collapse_7">
                How to remove devices that I once used to login to my GapxBit ?
              </button>
            </h2>
            ...
            <div id="collapse_1" className="accordion-collapse collapse" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  ...
                  <ol>
                    <li>1. Log in to GapxBit website  <b>[<a href="https://GapxBitglobal.io/" >https://GapxBitglobal.io/</a>]</b> </li>
            ...
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  ...
                  <p className=" mb-0 ">
                    In case the issue still persists, please raise a Support Ticket or write to us at <b><a href="mailto:support@GapxBitglobal.io" >support@GapxBitglobal.io</a></b> to reset2FA, and we will help reset the OTP preference on your account to SMS.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card-body card-body-padding-top border-bottom  ">
                <div className="faq_text" >
                  <p className="" >If you have forgotten your registered mobile number, you can raise a Support Ticket or write to
                    <b> <a href="mailto:support@GapxBitglobal.io"> support@GapxBitglobal.io</a> </b> attaching a selfie holding your original ID that you have submitted in KYC for
            ...
            <div id="collapse_4" className="accordion-collapse collapse" aria-labelledby="headingcollapse_4" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  ...
                  <p>If none of the above steps work, please submit a request to the support team at <a href="mailto:support@GapxBitglobal.io" >support@GapxBitglobal.io</a> and they will assist you further</p>
                  <p className=" mb-0 ">
      ...
      {changeScreen === "Email" && (
        <div className="faq " id="accordionExample">
              ...
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  ...
                  <ol>
                    ...
                    <li>3. Add GapxBit to your mailbox whitelist</li>
                  ...
                  <p className="mb-0"> <strong>Important:</strong> If none of the above steps work, please use an alternate email address. Or write to us at
                    <a href="mailto:support@GapxBitglobal.io" >support@GapxBitglobal.io</a> </p>
                </div>
              </div>
            </div>
          </div>
          <div className="card  p-0 ">
            <h2 className="card-header" id="headingcollapse_2">
              <button className="accordion-button p-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_2" aria-expanded="false" aria-controls="collapse_2">
                How to avoid/stop GapxBit emails from going to the spam/junk folder?
              </button>
            </h2>
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  <p className="" > If you find that your email service provider is pushing GapxBit emails into your spam/junk folder, please follow the steps below to add GapxBit email addresses to the safe mailing list.</p>
                  ...
                  <div className="px-md-3" >
                    ...
                    <ol>
                      ...
                      <li> Click <b>[Add]</b> to add the official GapxBit email addresses into the list</li>
                      <li> Click <b>[Save]</b> to save your settings</li>
                      <li> Addresses to add to the safe mailing list:</li>
                      <li> <b><a className="text-warning" href="mailto:no-reply@GapxBitglobal.io" >no-reply@GapxBitglobal.io</a></b></li>
                      <li> <b><a className="text-warning" href="mailto:info@GapxBitglobal.io" >info@GapxBitglobal.io</a></b> </li>
                      <li>  <b><a className="text-warning" href="mailto:news@GapxBitglobal.io" >news@GapxBitglobal.io</a></b> </li>
                      <li> <b><a className="text-warning" href="mailto:support@GapxBitglobal.io" >support@GapxBitglobal.io</a></b> </li>
                    ...
                    <ol>
                      ...
                      <li> Copy and paste the official GapxBit email addresses to the [From] field and click [Create filter] </li>
                      <li> Check the box next to <b>[Never send it to Spam]</b> and click <b>[Create filter]</b> </li>
                      <li> Addresses to add to the safe mailing list: </li>
                      <li> <b><a className="text-warning" href="mailto:no-reply@GapxBitglobal.io" > no-reply@GapxBitglobal.io</a></b> </li>
                      <li> <b><a className="text-warning" href="mailto:no-reply@GapxBitglobal.io" > info@GapxBitglobal.io</a></b> </li>
                      <li> <b><a className="text-warning" href="mailto:no-reply@GapxBitglobal.io" > news@GapxBitglobal.io</a></b> </li>
                      <li> <b><a className="text-warning" href="mailto:no-reply@GapxBitglobalio" > support@GapxBitglobalio</a></b> </li>
        ...
        <div className="faq " id="accordionExample">
          <div className="card p-0  ">
            ...
            <div id="collapse_1" className="accordion-collapse collapse" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <p>If you wish to change the registered email linked to your GapxBit account, kindly raise a Support Ticket
                    or write to us at support@GapxBitglobal.io attaching a selfie holding your original ID that you have submitted in KYC for verification.</p>
                  <p className=" ">
              ...
              <div className="card-body card-body-padding-top border-bottom  ">
                <div className="faq_text" >
                  <p className="" >If you wish to change or update your personal details like Name, Mobile number, or Email address linked
                    to your GapxBit account, you can do so by raising a Support Ticket or write to us at <b><a href="mailto:support@GapxBitglobal.io" >support@GapxBitglobal.io</a></b>
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_4" className="accordion-collapse collapse" aria-labelledby="headingcollapse_4" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className=" ">
                    User needs to create a support ticket and request or write to us on support@GapxBitglobalio for deletion of account.
                  </p>
                  <p className=" mb-0 ">
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_5" className="accordion-collapse collapse" aria-labelledby="headingcollapse_5" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    To change your password for GapxBit, click on 'Security' under Account. You will get an option to change
                  ...
                  <p className="mb-0">
                    ...
                    same password that you will be using in case you wish to login or withdraw from GapxBit app/web.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_6">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_6" aria-expanded="false" aria-controls="collapse_6">
                How to access the GapxBit account of someone who has passed away?
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_7" className="accordion-collapse collapse" aria-labelledby="headingcollapse_7" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    If you wish to change your registered mobile number with GapxBit, you can raise a Support Ticket
                    attaching a selfie holding your original ID that you have submitted in KYC for verification or write to us at
                    <b><a href="mailto:support@GapxBitglobal.io.">support@GapxBitglobal.io</a></b>
        ...
        <div className="faq " id="accordionExample">
          ...
          <div className="card  p-0 ">
            ...
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  <p className=" ">To add a nominee on GapxBit:</p>
                  <ol>
                    <li>1. Login to GapxBit app/web and click on the profile icon on top left of the screen.</li>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_5">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_5" aria-expanded="false" aria-controls="collapse_5">
                What happens to the proceedings if the nominee dies after the account holder but before the money is paid by GapxBit?
              </button>
            </h2>
            <div id="collapse_5" className="accordion-collapse collapse" aria-labelledby="headingcollapse_5" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_9">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_9" aria-expanded="false" aria-controls="collapse_8">
                Is nomination mandatory for a GapxBit account?
              </button>
            </h2>
              ...
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    ...
                    <br />
                    Please note that the nominee need not be a GapxBit account holder. Anyone can be a nominee. However, to
                    claim virtual digital assets, having an account on GapxBit is mandatory.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    ...
                    <br />
                    To add a update or remove a nominee on GapxBit:
                    <ol>
                      <li>1. Login to GapxBit app/ web and click on the profile icon on top left of the screen.</li>
                      <li>2. Tap on Account Settings.</li>
              ...
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    ...
                    ticket through the official support email (support@GapxBitglobal.io).
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="faq " id="accordionExample">
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_1" className="accordion-collapse collapse" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <p>Backup Codes are a random set of 8 digits (one time use only) that you can use to sign into your GapxBit
          ...
          <div className="card  p-0 ">
            <h2 className="card-header" id="headingcollapse_2">
              <button className="accordion-button p-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_2" aria-expanded="false" aria-controls="collapse_2">
                How can I create, reset and delete my Backup Codes on GapxBit website?
              </button>
            </h2>
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  ...
                  <p>
                    Log into your GapxBit web account
      ...
      {changeScreen === "Account Closure" && (
        <div className="faq " id="accordionExample">
              ...
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <p>Your crypto funds are safe and secure no matter how many times you log in and log out of your account or
                    ...
                    have any issues related to your GapxBit account, please contact the Support Team here
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card  p-0 ">
            ...
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  <p>
                    In case you think somebody has unauthorized access to your GapxBit account, please get in touch with
              ...
              <div className="card-body card-body-padding-top border-bottom  ">
                <div className="faq_text" >
                  <p className="" >
                    ...
                    <br />
                    In case you still doubt that your GapxBit account information has been compromised, please get in touch with
                    our support team and they will assist you further.
                  </p>
                </div>
              </div>
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_4" className="accordion-collapse collapse" aria-labelledby="headingcollapse_4" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className=" ">
                    In case your GapxBit account information has been compromised, please get in touch with our support
              ...
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    ...
                    use, you can simply log into your GapxBit account and Disable it yourself.
                    <br />
                  ...
                  <ol>
                    Steps to disable your account using GapxBit App:
                    <li>1. Log in to your GapxBit app/web.</li>
                    <li>2. Go to [Account] and select [Security].</li>
                    <li>3. Click [Disable Your Account].</li>
                  </ol>
                  <ol>
                    Steps to disable your account from Website:
                    <li>1. Log in to GapxBit website <a href="https://GapxBitglobal.io/" target="_blank" > https://GapxBitglobal.io/ </a>..</li>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_6">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_6" aria-expanded="false" aria-controls="collapse_6">
                How do I disable/deactivate my GapxBit account?
              </button>
            </h2>
              ...
              <div className="card-body card-body-padding-top border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    ...
                    <ol>
                      Steps to disable your account using GapxBit App:
                      <li>  Log in to your GapxBit app. </li>
                      <li> Go to [Account] and select [Security].</li>
                      <li> Click [Disable Your Account].</li>
                    </ol>
                    <ol>
                      Steps to disable your account from Website:
                      <li>  Log in to GapxBit website<a href="https://GapxBitglobal.io/" target="_blank" rel="noreferrer"> https://GapxBitglobal.io/ </a>.. </li>
