...
const FAQApi = () => {
  ...
  return (
    <div className="col-lg-8">
      ...
      {changeScreen === "main" && (
        <div className="faq_list">
          <a
            ...
            onClick={() => {
              setChangeScreen("Introduction to the GapxBit Global API");
            }}
          >
            <h5 className="mb-0"> Introduction to the GapxBit API</h5>
      ...
      {changeScreen === "main" && (
        <div className="faq_list">
          <a
            ...
            className="faq_item card text-start"
            onClick={() => {
              setChangeScreen("User Data on GapxBit API");
            }}
          >
            <h5 className="mb-0">User Data on GapxBit API</h5>
            <i className="ri-arrow-right-line"></i>
          </a>
        </div>
      )}
      ...
      {changeScreen === "main" && (
        <div className="faq_list">
          <a
            ...
            className="faq_item card text-start"
            onClick={() => {
              setChangeScreen("Market Data on GapxBit API");
            }}
          >
            <h5 className="mb-0">Market Data on GapxBit API</h5>
            <i className="ri-arrow-right-line"></i>
          </a>
        </div>
      )}
      ...
      {changeScreen === "main" && (
        <div className="faq_list">
          <a
            ...
            className="faq_item card text-start"
            onClick={() => {
              setChangeScreen("Placing Orders using GapxBit API");
            }}
          >
            <h5 className="mb-0">Placing Orders using GapxBit API</h5>
            <i className="ri-arrow-right-line"></i>
          </a>
        </div>
      )}
      ...
      {/* Introduction to the GapxBit API */}
      {changeScreen === "Introduction to the GapxBit API" && (
            ...
            <div id="collapse_1" className="accordion-collapse collapse show" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <ol>The GapxBit API serves various functionalities, including:
                    <li>1. Pulling Market Data based on specific requirements.</li>
                    <li>2. Placing and Managing different types of Orders on the GapxBit Books and Partner Exchanges.</li>
                    <li>3. To begin using the GapxBit API, you will need the following prerequisites:</li>
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_1" className="accordion-collapse collapse" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <ol>
                    You can find the API dashboard on the profile section of the GapxBit Web Platform. The
            ...
            <div id="collapse_1" className="accordion-collapse collapse show" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  ...
                  <h6>High-Frequency Trading using GapxBit</h6>
                  <p>GapxBit API offers specialized access to our High-Frequency APIs for enterprise clients. These APIs enable
                    our clients to trade and receive data with faster API response times and higher rate-limits.
                    The base URL for all HFT-related URLs is: <a href='https://hft-api.GapxBitglobal.io' target='_blank'>https://hft-api.GapxBitglobalioal.io</a> </p>
                  <p>To learn more about High-Frequency Trading using GapxBit API and access the specialized endpoint,
                    please contact us.</p>
              ...
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  ...
                  <p>You can also reach us through our official support channels for Telegram and Twitter, or write to us at
                    <a href='mailto:support@GapxBit.io' target='_blank'>support@GapxBit.io</a> </p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* User Data on GapxBit API */}
      {changeScreen === "User Data on GapxBit API" && (
        <div className="faq " id="accordionExample">
              ...
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  <p>This API endpoint allows you to retrieve user information for the specified account. You can use the following endpoint to access
                    this information:
                    Endpoint: https://api.GapxBitglobal.io/exchange/v1/users/info
                  ...
                  <p>
                    ...
                    [
                    <br />
                    "GapxBitglobal_id": "fda259ce-22fc-11e9-ba72-ef9b29b5db2b",<br />
                    "first_name": "First name",<br />
                    "last_name": "Last name",<br />
                    "mobile_number": "000000000",<br />
                    "email": "test@GapxBitglobal.io"<br />
                    ]
                  </p>
                  <table className='table' >
                    <thead>
      ...
      {/* Market Data on GapxBit API Tab */}
      {changeScreen === "Market Data on GapxBit API" && (
        <div className="faq " id="accordionExample">
              ...
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <p>Ticker data in the Crypto market is a real-time, streaming information used to monitor the prices of
                    ...
                    To pull Ticker data using GapxBit API, you can use the following endpoint:
                    Endpoint: https://api.GapxBitglobal.io/exchange/ticker
                    The GapxBit Ticker API endpoint provides the following information:</p>
                  <table className='table' >
                    <thead>
                      <tr>
                        <th>Parameter</th>
            ...
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  ...
                  <p>https://api.GapxBit.io/exchange/v1/markets</p>
          ...
          <div className="card  p-0  ">
            ...
            <div id="collapse_3" className="accordion-collapse collapse" aria-labelledby="headingcollapse_3" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top border-bottom  ">
                <div className="faq_text" >
                  <p>The GapxBit Market Details endpoint offers in-depth information about a particular market or trading pair. Utilizing this endpoint allows you
                    ...
                    To retrieve the market details, you can use the following endpoint:https://api.GapxBitglobal.io/exchange/v1/market_details</p>
                  <p>The GapxBit Market Details endpoint, will allow you to get the following information:</p>
            ...
            <div id="collapse_4" className="accordion-collapse collapse" aria-labelledby="headingcollapse_4" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  ...
                  <p>https://public.GapxBitglobal.io/market_data/trade_history/?pair={'insert_pair'}&limit={'insert_limit'}
                  ...
                  <h6>The GapxBit Trades API endpoint, gives you the following information:</h6>
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_5" className="accordion-collapse collapse" aria-labelledby="headingcollapse_5" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className=" ">
                    To extract order book data using the GapxBit API, use the following endpoint:
                  </p>
                  <p>https://public.GapxBitglobal.io/market_data/market_data/orderbook/?pair=B-BTC_USDT</p>
      ...
      {/* Placing Orders using GapxBit API Tab */}
      {changeScreen === "Placing Orders using GapxBit API" && (
        <div className="faq " id="accordionExample">
              ...
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  ...
                  <p>The biggest advantage of Spot trading is it is simple and easy to understand. It is a good place to start in
                    the crypto market.</p>
                  <p> The GapxBit API provides the following functionalities for Creating and Managing Spot Orders.</p>
                  <p> Placing new Orders</p>
                  <p>Cancelling an Order</p>
                  <p>  Exiting an Order</p>
                  <p>  Editing an Order</p>
                  <p> Getting data for orders placed</p>
                  <p> To know more about how to place spot orders using the GapxBit API, refer to the API Documentation..</p>
                </div>
              </div>
            </div>
          </div>
