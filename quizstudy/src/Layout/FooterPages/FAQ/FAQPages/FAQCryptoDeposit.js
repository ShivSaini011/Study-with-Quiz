          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_1">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_1" aria-expanded="false" aria-controls="collapse_1">
                How to Deposit Digital Assets to GapxBit【PC】
              </button>
            </h2>
            <div id="collapse_1" className="accordion-collapse collapse" aria-labelledby="headingcollapse_1" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top text-align-start border-bottom ">
                <div className="faq_text" >
                  <p>You can deposit digital assets from external platforms or wallets to GapxBit via a deposit address on the platform. How to
                    find the address?</p>
                  <p>1. Visit the GapxBit official website.</p>
          ...
          <div className="card  p-0 ">
            <h2 className="card-header" id="headingcollapse_2">
              <button className="accordion-button p-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_2" aria-expanded="false" aria-controls="collapse_2">
                How to Deposit Digital Assets on GapxBit【APP】
              </button>
            </h2>
            <div id="collapse_2" className="accordion-collapse collapse" aria-labelledby="headingcollapse_2" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom">
                <div className="faq_text" >
                  <p>You can deposit digital assets from external platforms or wallets to GapxBit via a deposit address on the platform.
                    How to find the address?</p>

                  <p>1. Open GapxBit App and click on [Balance].</p>
          ...
          <div className="card  p-0  ">
            <h2 className="card-header" id="headingcollapse_3">
              <button className="accordion-button p-0 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_3" aria-expanded="false" aria-controls="collapse_3">
                How to Withdraw Digital Assets from GapxBit【PC】
              </button>
            </h2>
              ...
              <div className="card-body card-body-padding-top border-bottom  ">
                <div className="faq_text" >
                  <p className="" >You can withdraw your digital assets to external platforms or wallets via their address. Copy the address from the external
                    platform or wallet, and paste it into the withdrawal address field on GapxBit to complete the withdrawal.</p>
                  <ol>
                    <li> 1. Visit GapxBit official website. </li>
                    ...
                    <li>  3. Click on [Withdrawal], and select the token you want to withdraw. Take USDT as an example.
                      <ol>
                        ...
                        <li>3) Copy the withdrawal address from an external platform or wallet, and paste it into the withdrawal address field
                          on GapxBit . You can also scan the QR Code on the external platform or wallet to withdraw</li>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_4">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_4" aria-expanded="false" aria-controls="collapse_4">
                How to Withdraw Digital Assets on GapxBit【APP】
              </button>
            </h2>
              ...
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className=" ">
                    ...
                    platform or wallet, and paste it into the withdrawal address field on GapxBit to complete the withdrawal.
                  </p>
                  <ol>
                    <li>1. Open GapxBit App, click on [Balance].</li>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_5">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_5" aria-expanded="false" aria-controls="collapse_5">
                Deposit to a Non-GapxBit address
              </button>
            </h2>
            <div id="collapse_5" className="accordion-collapse collapse" aria-labelledby="headingcollapse_5" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    GapxBit can NOT receive your crypto assets if they are deposited to a non-GapxBit addresses. We cannot help to retrieve
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_6" className="accordion-collapse collapse" aria-labelledby="headingcollapse_6" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="mb-0">
                    If you sent the wrong coins or missing memo/tag to your GapxBitX coin address:
                  </p>
                  <ol>
                    <li>1. GapxBit generally does not offer a token/coin recovery service.</li>
                    <li>2. If you have suffered a significant loss as a result of incorrectly deposited tokens/coins, GapxBit may, solely at our
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_7" className="accordion-collapse collapse" aria-labelledby="headingcollapse_7" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    Assets being deposited on GapxBit go through the following steps:
                  </p>
                  <ol>
                    ...
                    <li>3. Once the deposit is confirmed on the blockchain and credited to your GapxBit account, it will be considered a complete deposit.
                      Please be aware that network congestion can extend the transaction process. If your deposit is not yet credited to your GapxBit account, follow these steps to check its status:
                      <ol>
                        ...
                        <li>2. Check the block confirmation status with the TXID using the appropriate blockchain browser. If the number of block confirmations is lower than GapxBit requirement, please be patient.
                          Your deposit will be credited when the required number of confirmations is met.</li>
                        <li>3. If the number of block confirmations meets the GapxBit requirement but the deposit is still not credited to your account, email customer support at (support@GapxBit.io) and provide the
                          following information: your GapxBit account, token name, deposit amount, and Transaction ID (TXID).
                          <ol>Please note the following:
                            ...
                            <li>2. Network congestion may cause delays. If the block confirmation is still processing or the number of confirmations is lower than GapxBit's requirement, please be patient.</li>
                            <li>3. Always confirm the transaction information, especially the deposit address copied from GapxBit during asset transfers, to avoid unnecessary asset loss. Keep in mind that blockchain
                ...
                <div className='row' >
                  <div className='col-lg-8' >
                    <div className="faq_text" >
                      ...
                      <p>To facilitate the management, most trading platforms (like GapxBit) give one address for
                        ...
                        enter a Tag/Memo/Message when depositing on GapxBit to ensure that the deposit can
                        be credited. Users need to follow the tag rules of the target address when withdrawing
                        assets from GapxBit.</p>
                      <h6>Which cryptocurrencies use Destination Tag technology?</h6>
                      <p>The following cryptocurrencies available on GapxBit utilize destination tag technology:
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_11" className="accordion-collapse collapse" aria-labelledby="headingcollapse_11" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    There are no fees for a deposit. However, users need to pay fees when withdrawing assets from GapxBit.
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_12" className="accordion-collapse collapse" aria-labelledby="headingcollapse_12" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    Yes, there is. For specific digital assets, GapxBit sets the minimum deposit amount. Users need to make
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_13" className="accordion-collapse collapse" aria-labelledby="headingcollapse_13" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    Yes, there is. GapxBit sets the minimum withdrawal amount.
                    <br />
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_14" className="accordion-collapse collapse" aria-labelledby="headingcollapse_14" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    No. Users can deposit and withdraw assets on GapxBit anytime. If the deposit and withdrawal functions are
                    suspended because of block network breakdown, platform upgrade, etc., GapxBit will inform users via an
              ...
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    ...
                    Assets transfer out from GapxBit, block confirmation, and receiver accreditation. When users request a
                    withdrawal, the withdrawal will be verified immediately on GapxBit. However, it will take a little longer to
                    ...
                    always turn to GapxBit customer support when having issues with deposits or withdrawals.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_16" className="accordion-collapse collapse" aria-labelledby="headingcollapse_16" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    No. GapxBit strongly suggests that users should make sure the withdrawal address is correct by the copy-
          ...
          <div className="card p-0  ">
            ...
            <div id="collapse_18" className="accordion-collapse collapse" aria-labelledby="headingcollapse_18" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    No. Users can only transfer assets from GapxBit to one address via one withdrawal order. To transfer assets
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_19">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_19" aria-expanded="false" aria-controls="collapse_19">
                Can I transfer assets to a smart contract on GapxBit?
              </button>
            </h2>
            <div id="collapse_19" className="accordion-collapse collapse" aria-labelledby="headingcollapse_19" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    Yes. GapxBit withdrawal supports a transfer to smart contracts.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="card p-0  ">
            <h2 className="card-header" id="headingcollapse_20">
              <button className="accordion-button p-0  collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse_20" aria-expanded="false" aria-controls="collapse_20">
                Does an asset transfer among GapxBit accounts require fees?
              </button>
            </h2>
            <div id="collapse_20" className="accordion-collapse collapse" aria-labelledby="headingcollapse_20" data-bs-parent="#accordionExample">
              <div className="card-body card-body-padding-top  border-bottom ">
                <div className="faq_text" >
                  <p className="">
                    No. The GapxBitX system can automatically distinguish the internal addresses out and charges no fees for
